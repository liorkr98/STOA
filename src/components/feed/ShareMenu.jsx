...
const RedditLogo = () => (
  <svg viewBox="0 0 24 24" width="15" height="15" fill="#FF4500">
...
const TelegramLogo = () => (
  <svg viewBox="0 0 24 24" width="15" height="15" fill="#26A5E4">
...
const StockTwitsLogo = () => (
  <svg viewBox="0 0 24 24" width="15" height="15" fill="#40576D">
    <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm.75 5.25l2.25 4.5H15l-3 6-3-6h.75L12 5.25h.75z"/>
  </svg>
);
...
const PLATFORMS = [
  ...
  },
  {
    label: "StockTwits",
    logo: StockTwitsLogo,
    getUrl: (title, url) => `https://stocktwits.com/transmit/share?body=${encodeURIComponent(title + " " + url)}`,
  },
  {
    label: "LinkedIn",
    logo: LinkedInLogo,
    getUrl: (title, url) => `https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(url)}&title=${encodeURIComponent(title)}`,
  },
  {
    label: "Reddit",
    logo: RedditLogo,
  ...
  },
  {
    label: "Email",
    logo: EmailLogo,
    getUrl: (title, url) => `mailto:?subject=${encodeURIComponent(title)}&body=${encodeURIComponent("Check out this research report: " + url)}`,
  },
];
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-44">
        ...
        <DropdownMenuItem onClick={copyLink} className="cursor-pointer gap-2">
          <Link className="w-[15px] h-[15px] text-muted-foreground" />
          <span>Copy Link</span>
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
